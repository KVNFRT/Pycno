...
ax1 = fig.add_subplot(111)
ax2 = ax1.twinx()
sc = ax1.scatter(Density, Vop/Vpt, s=100, c=Depth, marker='o', cmap='viridis', edgecolor='#050505')
ax2.scatter(Density, Vcl/Vpt, s=100, c=Depth, marker='s', cmap='viridis', edgecolor='#050505')
cax = fig.colorbar(sc)
...
fig.subplots_adjust(top=.95,bottom=.1,left=.05,right=1.00)
ax1 = fig.add_subplot(111)
sc = ax1.scatter(Density, Vcl/Vpt, s=100, c=Depth, marker='o', cmap='viridis', edgecolor='#050505')
cax = fig.colorbar(sc)
cax.set_label('Depth (m)')
ax1.set_ylabel('Closed/Total Porosity' )
ax1.set_xlabel('Density (g/cm3)')
...
fig.subplots_adjust(top=.95,bottom=.1,left=.05,right=1.00)
ax1 = fig.add_subplot(111)
sc = ax1.scatter((Vcl+Vop)/Vtot, Vcl/Vtot, s=100, c=Depth, marker='o', cmap='viridis', edgecolor='#050505')
